...
double run_remove_if_benchmark_std(int test_count, OrgIter org_first,
    OrgIter org_last, InIter first, InIter last, Pred pred)
{
    ...
    std::size_t random_range, IteratorTag, DataType)
{
    ...
    double time_std = run_remove_if_benchmark_std(
